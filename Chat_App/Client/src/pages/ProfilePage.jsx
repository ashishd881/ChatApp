...
function ProfilePage() {
  // we will get the image inside label tag with the help of state variable so we create a useState
  const [selectedImg, setSelectedImg] = useState(null)
  const navigate = useNavigate();
  const [name, setName] = useState("Martin Jhonson")
  const [bio, setBio] = useState(" Hi Everyone, Mai quick chalata hu")
